...
$CFG->dbtype    = 'cockroachdb';      // 'cockroachdb', 'pgsql', 'mariadb', 'mysqli', 'mssql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = getenv('DB_PORT_3306_TCP_ADDR');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('DB_ENV_PGSQL_DATABASE');     // database name, eg moodle
$CFG->dbuser    = getenv('DB_ENV_PGSQL_USER');   // your database username
$CFG->dbpass    = getenv('DB_ENV_PGSQL_PASSWORD');   // your database password
...
$CFG->dboptions = array(
    ...
    'dbcollation' => false,     // 'utf8mb4_unicode_ci', // MySQL has partial and full UTF-8
